...
let ChooseFlavor = (props) => {
  ...
  return (
    ...
    <div className='block'></div>
      ...
      <span onClick={() => {props.toggleCone();props.toggleFlavor();}} className='left-arrow'>〈</span>
      <span id='choose'><strong>Choose Flavor</strong></span>
      <span className='right-arrow' onClick={() => {props.toggleSauce();props.toggleFlavor();}}>〉</span>
      <div id='carousel'>
      <Carousel>
